...
from lauda.models import Vehicle, Driver
...
#     vehicle_status = forms.ChoiceField(choices=STATUS_OPTIONS)
#
#     def clean_year(self):
...
class VehicleAdminForm(forms.ModelForm):
    ...
    driver_assigned = forms.ModelChoiceField(queryset=Driver.objects.all())
